...
namespace RestFullAPI.Controllers
{
    ...
    // ProducesRepsonseType özniteliği kullanılarak bu dönüş tipleri Swagger gibi araçlar tarafından web API dökümantasyonlarında istemcikler için daha açıklayıcı yanıt ayrıntıları belirtir.
